...
var GeminiAdapter = /** @class */ (function (_super) {
    __extends(GeminiAdapter, _super);
    function GeminiAdapter() {
        ...
        if (_this.isAvailable()) {
            _this.client = new generative_ai_1.GoogleGenerativeAI(env_1.env.GEMINI_API_KEY);
        }
        return _this;
    }
    GeminiAdapter.prototype.isAvailable = function () {
        return !!env_1.env.GEMINI_API_KEY;
    };
    GeminiAdapter.prototype.generateJSON = function (prompt, modelId) {
