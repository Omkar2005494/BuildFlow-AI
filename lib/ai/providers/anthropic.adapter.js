...
var AnthropicAdapter = /** @class */ (function (_super) {
    __extends(AnthropicAdapter, _super);
    ...
    AnthropicAdapter.prototype.isAvailable = function () {
        return !!env_1.env.ANTHROPIC_API_KEY;
    };
    AnthropicAdapter.prototype.generateJSON = function (prompt, modelId) {
