...
var GroqAdapter = /** @class */ (function (_super) {
    __extends(GroqAdapter, _super);
    function GroqAdapter() {
        ...
        if (_this.isAvailable()) {
            _this.client = new groq_sdk_1.default({
    ...
    GroqAdapter.prototype.isAvailable = function () {
        return !!env_1.env.GROQ_API_KEY;
    };
    GroqAdapter.prototype.generateJSON = function (prompt, modelId) {
