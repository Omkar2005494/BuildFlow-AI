...
var OpenAIAdapter = /** @class */ (function (_super) {
    __extends(OpenAIAdapter, _super);
    ...
    OpenAIAdapter.prototype.isAvailable = function () {
        return !!env_1.env.OPENAI_API_KEY;
    };
    OpenAIAdapter.prototype.generateJSON = function (prompt, modelId) {
